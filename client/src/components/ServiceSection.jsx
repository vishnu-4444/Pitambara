          ...
          <div className='grid gap-8 sm:grid-cols-2 lg:grid-cols-3'>
            <div className='bg-white shadow-md rounded-lg p-6 text-center hover:bg-teal-50'>
              ...
              <p className='text-gray-600 text-sm mb-3'>
                Identify and fix vulnerabilities across your systems.
              </p>
            ...
            <div className='bg-white shadow-md rounded-lg p-6 text-center hover:bg-teal-50'>
              ...
              <p className='text-gray-600 text-sm mb-3'>
              Ensure your organization meets all regulatory and industry-specific cybersecurity requirements.
              </p>
              <a href="#" className='text-teal-600 font-medium hover:underline'>
                Learn More →
              </a>
            ...
            <div className='bg-white shadow-md rounded-lg p-6 text-center hover:bg-teal-50'>
              ...
              <p className='text-gray-600 text-sm mb-3'>
              Continuously monitor systems to identify and respond to potential security threats in real time.
              </p>
              <a href="#" className='text-teal-600 font-medium hover:underline'>
                Learn More →
              </a>
