...
const HeroSection = () => {
    return (
        <div className="flex justify-between items-center min-h-screen px-16 pt-0 pr-30 mt-0">
            <div className="max-w-xl flex-1">
                <h1 style={{ color: '#201c8c' }} className="text-5xl font-bold leading-tight mb-6">
                    Dynamic Solutions <br />
                    That <span style={{ color: '#f8a404' }}>Power High</span><br />
                    Growth Startups
                </h1>
                <p className="text-gray-600 mb-6">
                    Agilos helps you to convert your data into a startergic asset and get
                    business insights Agilos helps you to convert.
                </p>
                <Link href="/contact" className="inline-block px-8 py-3 border border-dblue text-dblue font-bold rounded-xl hover:bg-dblue hover:text-white transition">
                    Get Started →
                </Link>
            </div>

            <div className="flex-1 flex justify-end relative w-[500px] h-[700px]">
                <Image src="/hero.png"
                    alt="A guy"
                    width={500}
                    height={700}
            ...
            <div className="absolute top-1/2 right-0 -translate-y-1/2 z-20 items-end pt-80">
                    <div className="flex flex-col items-center space-y-4">
                        <span className="font-bold text-dblue rotate-270 uppercase tracking-widest">Follow Us</span>
                        <div className="w-px h-30" />

                        <div className="flex flex-row space-x-3 mt-2 rotate-270">
                            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="group">
                                <svg
                                    ...
                                    fill="currentColor"
                                    className="w-6 h-6 text-dblue group-hover:text-dyellow transition-colors">
